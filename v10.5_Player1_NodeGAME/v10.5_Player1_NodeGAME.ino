 ...
 * NodeMCU ESP8266 IP Address for PERMATA B18 --> 192.168.1.5
 */
...
void play_PingPong_Multi()  {
  ...
  JSONencoder["dataType"] = "Load_Ball_Position_Score";
  JsonArray& values = JSONencoder.createNestedArray("values");

  values.add(loading_pingpong);
  values.add(ball_coorX);
  values.add(ball_coorY);
  values.add(playerOne_Position);
  values.add(playerOne_Score);
  values.add(playerTwo_Score);
...
//   http.begin("http://192.168.1.2:1880/pingpong/p1/post/jsondata");      //Specify request destination
   http.begin("http://192.168.43.170:1880/pingpong/p1/post/jsondata");      //Specify request destination
  ...
  //////////////////////PINGPONG GET HTTP REQUEST///////////////////////
      ...
      http.begin("http://192.168.43.170:1880/pingpong/p2/get/jsondata");
//      http.begin("http://192.168.1.2:1880/pingpong/p2/get/jsondata");
   int p2_JSONGet = http.GET();


  if(p2_JSONGet == 200) {
   String p2_JSONMessage = http.getString();
    Serial.print("Initial string value: "); Serial.println(p2_JSONMessage);
    
    StaticJsonBuffer<300> JSONBuffer;   //Memory pool
    JsonObject& parsed = JSONBuffer.parseObject(p2_JSONMessage); //Parse message
...
//    Serial.println(arraySize);
    ...
    p2_ready = parsed["values"][0];
    playerTwo_Position = parsed["values"][1];
  }
    http.end();
/////////////////////////////////////////////////////////////////////////////
  display.clearDisplay();
...
//    http.begin("http://192.168.1.2:1880/tictactoe/player_x/post/signal");
...
//  http.begin("http://192.168.1.2:1880/tictactoe/player_o/get/signal");
...
//  http.begin("http://192.168.1.2:1880/tictactoe/player_o/get/row");
...
//  http.begin("http://192.168.1.2:1880/tictactoe/player_o/get/column");
...
//  http.begin("http://192.168.1.2:1880/tictactoe/player_o/get/turn");
...
//            http.begin("http://192.168.1.2:1880/tictactoe/player_x/post/row");
            http.addHeader("Content-Type", "text/plain");
...
//            http.begin("http://192.168.1.2:1880/tictactoe/player_x/post/column");
            http.addHeader("Content-Type", "text/plain");
...
//            http.begin("http://192.168.1.2:1880/tictactoe/player_x/post/turn");
            http.addHeader("Content-Type", "text/plain");
